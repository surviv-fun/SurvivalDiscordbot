...
package fun.surviv.discord.cli.console;

import java.io.PrintStream;

import static fun.surviv.discord.cli.SurvivalDiscordBotCLI.isRealTerminal;
import static java.util.Objects.requireNonNull;

/**
 * SurvivalDiscordbot; fun.surviv.discord.cli.console:ConsolePrinter
 *
